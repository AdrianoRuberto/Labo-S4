...
const QMetaObject VoieButtoir::staticMetaObject = {
    { &Voie::staticMetaObject, qt_meta_stringdata_VoieButtoir.data,
      qt_meta_data_VoieButtoir,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VoieButtoir::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VoieButtoir.stringdata0))
        return static_cast<void*>(const_cast< VoieButtoir*>(this));
