...
const QMetaObject ExplosionItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ExplosionItem.data,
      qt_meta_data_ExplosionItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ExplosionItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ExplosionItem.stringdata0))
        return static_cast<void*>(const_cast< ExplosionItem*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< ExplosionItem*>(this));
...
void SimView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SimView::*_t)(Segment * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SimView::locoSurSegment)) {
                *result = 0;
            }
        }
        {
            typedef void (SimView::*_t)(Voie * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SimView::notificationVoieVariableModifiee)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject SimView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_SimView.data,
      qt_meta_data_SimView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
