...
void CommandeTrain::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CommandeTrain::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::addLoco)) {
                *result = 0;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::setLoco)) {
                *result = 1;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::askLoco)) {
                *result = 2;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::setVitesseLoco)) {
                *result = 3;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::reverseLoco)) {
                *result = 4;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::setVitesseProgressiveLoco)) {
                *result = 5;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::stopLoco)) {
                *result = 6;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::setVoieVariable)) {
                *result = 7;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::selectMaquette)) {
                *result = 8;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::afficheMessage)) {
                *result = 9;
            }
        }
        {
            typedef void (CommandeTrain::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CommandeTrain::afficheMessageLoco)) {
                *result = 10;
            }
        }
    }
...
const QMetaObject CommandeTrain::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CommandeTrain.data,
      qt_meta_data_CommandeTrain,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CommandeTrain::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CommandeTrain.stringdata0))
        return static_cast<void*>(const_cast< CommandeTrain*>(this));
