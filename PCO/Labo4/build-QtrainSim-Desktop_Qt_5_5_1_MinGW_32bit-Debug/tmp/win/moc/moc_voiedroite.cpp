...
const QMetaObject VoieDroite::staticMetaObject = {
    { &Voie::staticMetaObject, qt_meta_stringdata_VoieDroite.data,
      qt_meta_data_VoieDroite,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VoieDroite::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VoieDroite.stringdata0))
        return static_cast<void*>(const_cast< VoieDroite*>(this));
