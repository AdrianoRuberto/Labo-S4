...
const QMetaObject VoieCourbe::staticMetaObject = {
    { &Voie::staticMetaObject, qt_meta_stringdata_VoieCourbe.data,
      qt_meta_data_VoieCourbe,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VoieCourbe::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VoieCourbe.stringdata0))
        return static_cast<void*>(const_cast< VoieCourbe*>(this));
