...
void VoieVariable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VoieVariable::*_t)(Voie * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VoieVariable::etatModifie)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject VoieVariable::staticMetaObject = {
    { &Voie::staticMetaObject, qt_meta_stringdata_VoieVariable.data,
      qt_meta_data_VoieVariable,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VoieVariable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VoieVariable.stringdata0))
        return static_cast<void*>(const_cast< VoieVariable*>(this));
