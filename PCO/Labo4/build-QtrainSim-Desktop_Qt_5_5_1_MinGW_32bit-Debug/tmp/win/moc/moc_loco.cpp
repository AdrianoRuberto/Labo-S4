...
const QMetaObject panneauNumLoco::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_panneauNumLoco.data,
      qt_meta_data_panneauNumLoco,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *panneauNumLoco::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_panneauNumLoco.stringdata0))
        return static_cast<void*>(const_cast< panneauNumLoco*>(this));
    if (!strcmp(_clname, "QAbstractGraphicsShapeItem"))
        return static_cast< QAbstractGraphicsShapeItem*>(const_cast< panneauNumLoco*>(this));
...
void Loco::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Loco::*_t)(Contact * , Contact * , Loco * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Loco::nouveauSegment)) {
                *result = 0;
            }
        }
        {
            typedef void (Loco::*_t)(Loco * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Loco::deraillement)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Loco::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Loco.data,
      qt_meta_data_Loco,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Loco::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Loco.stringdata0))
        return static_cast<void*>(const_cast< Loco*>(this));
    if (!strcmp(_clname, "QAbstractGraphicsShapeItem"))
        return static_cast< QAbstractGraphicsShapeItem*>(const_cast< Loco*>(this));
    return QObject::qt_metacast(_clname);
}
